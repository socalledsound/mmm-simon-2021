...
export const joinColor = '#381103'
export const joinColorAlt = '#ff9d8a'

export const questionMarkColor = '#fff0ff'

export const controlIconColors = {
    lineColor : '#ccc8cc',
    knobColor: '#1eadeb',
    knobEyeColor: "#1d2169",
}
